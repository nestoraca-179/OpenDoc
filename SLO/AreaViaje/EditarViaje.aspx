...
<form id="Form1" runat="server">
    <asp:Panel ID="PN_Success" runat="server" Width="100%" Visible="false">
        <div class="alert alert-success m-0">
            <p class="m-0">El viaje ha sido modificado con éxito</p>
        </div>
    </asp:Panel>
    ...
    <asp:Panel ID="PN_ContainerForm" runat="server" CssClass="container-form">
        <div class="form-header">
            <div class="row">
                ...
                <div class="col">
                    <dx:ASPxLabel ID="LBL_IDViaje" runat="server" Width="100%" CssClass="title-screen mt-3"></dx:ASPxLabel>
                </div>
                <div class="col d-flex justify-content-center">
        ...
        <hr />
        <div class="form-body">
            <h3 class="text-center mb-3">Lista de BLS</h3>
            <div class="form-grid">
