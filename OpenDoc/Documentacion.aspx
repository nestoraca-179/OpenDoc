<%@ Page Title="Documentación" Language="C#" MasterPageFile="Main.Master" AutoEventWireup="true" CodeBehind="Documentacion.aspx.cs" Inherits="OpenDoc.Documentacion" %>
    ...
    <div class="container-form">
        ...
        <div class="form-body">
            ...
            <div class="form-grid">
                ...
                <asp:SqlDataSource runat="server" ID="DS_Viaje" ConnectionString='<%$ ConnectionStrings:OpenDocConnectionString %>' SelectCommand="SELECT [ID], [file_path], [num_viaj], [fec_sal], [fec_arr], [total_bls], [total_paq], [total_cont], [id_trans], [cod_pto_sal], [cod_pto_des], [fe_us_in] FROM [Viaje] ORDER BY [fe_us_in] DESC"></asp:SqlDataSource>
            </div>
        </div>
    </div>
    <%-- MODAL WAITING --%>
