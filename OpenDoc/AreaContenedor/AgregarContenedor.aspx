<%@ Page Title="Agregar Contenedor" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="AgregarContenedor.aspx.cs" Inherits="OpenDoc.AreaContenedor.AgregarContenedor" %>
            ...
            <div class="row">
                <div class="col">
                    <div class="controls">
                        ...
                        <dx:ASPxTextBox ID="TB_NumCont" runat="server" Theme="Material" Width="100%">
