<%@ Page Title="Editar Contenedor" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="EditarContenedor.aspx.cs" Inherits="OpenDoc.AreaContenedor.EditarContenedor" %>
...
<form id="Form1" runat="server" class="container">
    <asp:Panel ID="PN_Success" runat="server" Width="100%" Visible="false" CssClass="mt-2">
            ...
            <div class="row">
                ...
                <div class="col">
                    <div class="controls">
                        ...
                        <asp:SqlDataSource runat="server" ID="DS_TipoContenedor" ConnectionString='<%$ ConnectionStrings:OpenDocConnectionString %>' SelectCommand="SELECT [ID], [nom_tipo] FROM [TipoContenedor]"></asp:SqlDataSource>
                    </div>
                </div>
                <div class="col">
                    <div class="controls">
                        ...
                        <asp:SqlDataSource runat="server" ID="DS_Estado" ConnectionString='<%$ ConnectionStrings:OpenDocConnectionString %>' SelectCommand="SELECT [ID], [nom_estado] FROM [EstadoContenedor]"></asp:SqlDataSource>
                    </div>
                </div>
            </div>
            <div class="row">
