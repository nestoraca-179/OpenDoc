...
namespace OpenDoc.Controllers
{
    public class ViajeController : Repository
    {
        ...
        public static int Add(EnumerableRowCollection<DataRow> table, string path, Usuario user)
        {
            int result = 0;
            ...
            using (DbContextTransaction tran = db.Database.BeginTransaction())
            {
                try
                {
                    ...
                    viaje.co_us_in = user.username;
                    viaje.fe_us_in = DateTime.Now;
                    viaje.co_us_mo = user.username;
                    ...
                    LogController.CreateLog(user.username, "VIAJE", new_viaje.ID, "I", null);
                    tran.Commit();
                    result = 1;
                }
                catch (Exception ex)
