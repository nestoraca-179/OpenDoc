<%@ Page Title="Editar BL" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="EditarBL.aspx.cs" Inherits="OpenDoc.AreaBL.EditarBL" %>
    ...
    <asp:Panel ID="PN_ContainerForm" runat="server" CssClass="container-form">
            ...
            <div class="row">
                ...
                <div class="col">
                    <div class="controls">
                        ...
                        <asp:SqlDataSource runat="server" ID="DS_TipoBL" ConnectionString='<%$ ConnectionStrings:OpenDocConnectionString %>' SelectCommand="SELECT [ID], [nom_tip_bl] FROM [TipoBL]"></asp:SqlDataSource>
                    </div>
                </div>
                <div class="col">
                    <div class="controls">
            ...
            <div class="row">
                ...
                <div class="col">
                    <div class="controls">
                        ...
                        <asp:SqlDataSource runat="server" ID="DS_TipoMercancia" ConnectionString='<%$ ConnectionStrings:OpenDocConnectionString %>' SelectCommand="SELECT [ID], [nom_mercancia] FROM [TipoMercancia]"></asp:SqlDataSource>
                    </div>
                </div>
            </div>
            <div class="row">
            ...
            <div class="row">
                ...
                <div class="col">
                    <div class="controls">
                        ...
                        <asp:SqlDataSource runat="server" ID="DS_TipoPaquete" ConnectionString='<%$ ConnectionStrings:OpenDocConnectionString %>' SelectCommand="SELECT [ID], [nom_tip_paq] FROM [TipoPaquete]"></asp:SqlDataSource>
                    </div>
                </div>
                <div class="col">
                    <div class="controls">
        ...
        <div class="form-body">
            ...
            <div class="form-grid">
                ...
                <asp:SqlDataSource runat="server" ID="DS_Contenedor" ConnectionString='<%$ ConnectionStrings:OpenDocConnectionString %>' SelectCommand="SELECT [ID], [num_cont], [num_paq], [tip_cont], [estado], [eq_inter_rec1], [eq_inter_rec2], [eq_inter_rec3] FROM [Contenedor] WHERE ([id_bl] = @id_bl)">
                    <SelectParameters>
