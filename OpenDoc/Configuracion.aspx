<%@ Page Title="Configuracion | OpenDoc" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="Configuracion.aspx.cs" Inherits="OpenDoc.Configuracion" %>
...
<form id="Form1" runat="server" class="container">
    ...
    <asp:SqlDataSource runat="server" ID="DS_Usuario" ConnectionString='<%$ ConnectionStrings:OpenDocConnectionString %>' SelectCommand="SELECT [ID], [username], [descrip], [email], [region], [activo] FROM [Usuario]"></asp:SqlDataSource>
    <%-- MODAL DELETE --%>
